<?php
/**
 * Plugin Name:       TPP-AI-Plugin
 * Description:       TPP plugin with reactjs.
 ...
 */
 ...
 function jobplace_admin_enqueue_scripts() {
     wp_enqueue_style( 'jobplace-style', plugin_dir_url( __FILE__ ) . 'panda/index.css' );
     wp_enqueue_script( 'jobplace-script', plugin_dir_url( __FILE__ ) . 'panda/index.js', array( 'wp-element' ), '1.0.0', true );
 }
...
//------------------chatbot start ----------------------------------
wp_enqueue_style( "tpp-chatbot-style", plugin_dir_url( __FILE__ ) . "chatbot/index.css" );

wp_enqueue_script( "tpp-chatbot-script", plugin_dir_url( __FILE__ ) . "chatbot/index.js" , array( 'wp-element' ), '1.0.0', true);
